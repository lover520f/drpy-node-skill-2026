...
description: 适用于 drpy-node 源播放链路排查与 lazy 修复。用户提到"播放不通""lazy 不对""play.html 被当直链""iframe 提取""m3u8 提取""parse:0/1 判断""假播放""站外解析""加密链接""webplay"时使用。专注判断播放是否真实可播；detail 不稳定、整体修源和仓库上传应分流。
---
